...
// if문을 이용한 조건부 반환
// - JSX 외부(return 밖)에서 조건에 따라 retuen을 다르게 주는 방법
function IfComponent({ num }: Props) {
    // num 값이 양수면 빨간색, 음수면 파란색, 0이면 초록색
    if (num > 0) {
        return (
...
// 삼항연산자(? :)를 이용한 조건부 렌더링
// JSX 내부(return 안)에서 상황(조건)에 따라서 렌더링하고자 할 때 사용
...
// 논리 연산자를 이용한 조건부 렌더링
// JSX 내부(return 안)에서 상황(조건)에 따라서 렌더링하고자 할 떄 사용
